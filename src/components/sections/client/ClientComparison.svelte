<script lang="ts">
  ...
  interface ClientComparisonTranslations {
    title: string;
    subtitle: string;
    noexClient: string;
    competitors: string[];
  ...
  interface Props {
    translations: ClientComparisonTranslations;
  }
...
<section
  ...
  aria-labelledby="client-comparison-title"
>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th class="noex-col">{translations.noexClient}</th>
