<script lang="ts">
  ...
  interface RulesComparisonTranslations {
    title: string;
    subtitle: string;
    noexRules: string;
    competitors: string[];
  ...
  interface Props {
    translations: RulesComparisonTranslations;
  }
...
<section
  ...
  aria-labelledby="rules-comparison-title"
>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th class="noex-col">{translations.noexRules}</th>
