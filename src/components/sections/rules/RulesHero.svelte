<script lang="ts">
  ...
  interface RulesHeroTranslations {
    headline: string;
    subheadline: string;
    install: string;
    github: string;
  ...
  interface Props {
    translations: RulesHeroTranslations;
    githubUrl?: string;
  }

  let {
    translations,
    githubUrl = 'https://github.com/hamicek/noex-rules',
  }: Props = $props();

  let isVisible = $state(false);
  let copied = $state(false);

  const installCommand = 'npm install @hamicek/noex-rules';
  ...
  function scrollToFeatures() {
    const section = document.getElementById('rules-features');
    if (section) {
...
<section id="rules-hero" class="hero-section snap-section bg-bg-primary">
  ...
  <div class="code-background" aria-hidden="true">
    <pre class="floating-code"><code><span class="code-keyword">const</span> rule = Rule.<span class="code-method">create</span>(<span class="code-string">'alert'</span>)</code>
<code>  .<span class="code-method">when</span>(<span class="code-method">onEvent</span>(<span class="code-string">'order.created'</span>))</code>
<code>  .<span class="code-method">if</span>(<span class="code-method">event</span>(<span class="code-string">'amount'</span>).<span class="code-method">gte</span>(<span class="code-number">100</span>))</code>
<code>  .<span class="code-method">then</span>(<span class="code-method">emit</span>(<span class="code-string">'notify'</span>))</code>
<code>  .<span class="code-method">build</span>();</code></pre>
  </div>
  ...
  <div class="hero-content max-w-4xl mx-auto text-center relative z-10" class:visible={isVisible}>
    ...
    <h1 class="text-5xl md:text-7xl font-bold mb-6">
      <span class="logo-text">noex-rules</span>
    </h1>
    ...
    <div class="cta-buttons flex flex-col sm:flex-row gap-4 justify-center mt-6">
      <a
        ...
        class="cta-secondary px-8 py-3 border border-border text-text-primary rounded-lg hover:border-accent-primary hover:text-accent-primary transition-all"
      >
...
<style>
  ...
  .code-keyword { color: var(--color-accent-primary); }
