<script lang="ts">
  ...
  interface RulesCtaTranslations {
    title: string;
    subtitle: string;
    install: string;
    copied: string;
  ...
  interface Props {
    translations: RulesCtaTranslations;
  ...
  let {
    ...
    docsUrl = 'https://github.com/hamicek/noex-rules#readme',
...
<section
  ...
  id="rules-cta"
  class="cta-section snap-section bg-bg-primary"
  aria-labelledby="rules-cta-title"
>
